...
// ADMIN
import { CreateService } from './pages/admin/create-service/create-service';
import { EditService } from './pages/admin/edit-service/edit-service';
import { ServiceList as AdminServiceList } from './pages/admin/service-list/service-list';
...
export const ADMIN_SERVICES_ROUTES: Routes = [
  ...
  { path: 'crear', component: CreateService },
